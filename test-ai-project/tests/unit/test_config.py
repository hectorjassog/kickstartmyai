...
class TestSettingsValidation:
    ...
    def test_default_settings(self):
        ...
        with patch.dict(os.environ, {"SECRET_KEY": "test-secret-key"}, clear=False):
            ...
            assert settings.PROJECT_NAME == "Test AI Project"
            assert settings.PROJECT_SLUG == "test-ai-project"
...
class TestSettingsDefaults:
    ...
    def test_default_database_settings(self):
        ...
        with patch.dict(os.environ, {"SECRET_KEY": "test-secret"}):
            ...
            assert settings.POSTGRES_USER == "test-ai-project_user"
            assert settings.POSTGRES_DB == "test-ai-project_db"
