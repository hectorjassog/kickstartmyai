...
class Settings(BaseSettings):
    ...
    PROJECT_NAME: str = "Test AI Project"
    PROJECT_SLUG: str = "test-ai-project"
    VERSION: str = "0.1.0"
    DESCRIPTION: str = "A FastAPI project with AI capabilities"
    DEBUG: bool = False
    ...
    POSTGRES_USER: str = "test-ai-project_user"
    POSTGRES_PASSWORD: str = ""
    POSTGRES_DB: str = "test-ai-project_db"
    ...
    CACHE_PREFIX: str = "test-ai-project"
